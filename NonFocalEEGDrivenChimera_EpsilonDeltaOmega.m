function [CMF, degreeSync, decayTime] = NonFocalEEGDrivenChimera_EpsilonDeltaOmega(N, b, alphaD, nEpsilon, nDOmega, ii)
% FocalEEGDrivenChimera_EpsilonDeltaOmega
% ---------------------------------------
% Simulate a 1-layer chimera network driven by a *non-focal* EEG phase signal
...
%% EEG driver: non-focal channel, resampling, phase, trimming, unwrapping
driver_temp = load( ...
    sprintf('/gpfs/home/jepifanio/Codes/EEG/BernBarcelona/Data_mat_NONFOCAL/Data_N_Ind%04d.mat', ii) ...
).Data_N;
